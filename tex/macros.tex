...
\def\question{\includegraphics[width=0.3in]{why.jpg}\,}
\def\answer{\includegraphics[width=0.3in]{baozou_haha.png}\,}
...
\def\thinka#1{\begin{frame}\frametitle{思考题}\bcenter\lfig{0.4}{think.jpg}  \skipline #1 \ecenter\end{frame}}
