...
\begin{frame}
  ...
  转化为单位圆上的围道积分：
  \bea
  c_n &=& \frac{1}{2\pi n!\ii}\oint (z-\frac{1}{z})^n \frac{1}{z^{m+1}} dz \newl
  &=&  \frac{1}{2\pi  \ii}\oint\sum_{k=0}^n \frac{1}{k!(n-k)!} (-1)^kz^{n-2k-m-1} dz
  \eea
...
\begin{frame}
  ...
  &\approx & \frac{1}{\pi}\mathrm{Re}\left[e^{-\ii\phi}\int_{-\infty}^{\infty}e^{\frac{ \ii x}{2}\epsilon^2} d\epsilon\right]  \newl
  &\approx & \frac{2}{\pi}\mathrm{Re}\left[e^{-\ii\phi}\int_0^{\infty}e^{\frac{ \ii x}{2}\epsilon^2} d\epsilon\right]  \newl  
  \eea
