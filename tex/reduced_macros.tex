...
%%symbols
\def\tbfill{\underline{\ \hspace{0.8in}\ }}
\def\uline#1{\underline{\ \hspace{#1 in}\ }}
\def\intfull{\int_{-\infty}^\infty}
\def\inthalf{\int_0^\infty}
\def\bropt{\,(\ \ \ )}
\def\brans#1{\,(\ {\blue #1}\ )}
\def\ans#1{\ \ \underline{\blue \ #1 \ }\ \ }
\def\optlist#1#2#3#4{({\bf A})\,#1\ \ ({\bf B})\,#2\ \ ({\bf C})\,#3\ \ ({\bf D})\,#4}
\def\foptlist#1#2#3#4{({\bf A})\,#1\ \ ({\bf B})\,#2\ \ ({\bf C})\,#3 \\ ({\bf D})\,#4}
\def\goptlist#1#2#3#4{({\bf A})\,#1\ \ ({\bf B})\,#2\\  ({\bf C})\,#3  ({\bf D})\,#4}
\def\sone{$\star$}
\def\stwo{$\star\star$}
